...
#include <jni.h>
/* Header for class org_jetbrains_kotlinx_multik_jni_JniMath */

#ifndef _Included_org_jetbrains_kotlinx_multik_jni_JniMath
#define _Included_org_jetbrains_kotlinx_multik_jni_JniMath
#ifdef __cplusplus
extern "C" {
#endif
/*
