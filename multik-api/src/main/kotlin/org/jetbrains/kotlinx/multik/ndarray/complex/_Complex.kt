...
public operator fun Byte.div(other: ComplexFloat): ComplexFloat = ComplexFloat(this / other.re, other.im)
public operator fun Short.div(other: ComplexFloat): ComplexFloat = ComplexFloat(this / other.re, other.im)
public operator fun Int.div(other: ComplexFloat): ComplexFloat = ComplexFloat(this / other.re, other.im)
public operator fun Long.div(other: ComplexFloat): ComplexFloat = ComplexFloat(this / other.re, other.im)
public operator fun Float.div(other: ComplexFloat): ComplexFloat = ComplexFloat(this / other.re, other.im)
public operator fun Double.div(other: ComplexFloat): ComplexDouble = ComplexDouble(this / other.re, other.im)
public operator fun Byte.div(other: ComplexDouble): ComplexDouble = ComplexDouble(this / other.re, other.im)
public operator fun Short.div(other: ComplexDouble): ComplexDouble = ComplexDouble(this / other.re, other.im)
public operator fun Int.div(other: ComplexDouble): ComplexDouble = ComplexDouble(this / other.re, other.im)
public operator fun Long.div(other: ComplexDouble): ComplexDouble = ComplexDouble(this / other.re, other.im)
public operator fun Float.div(other: ComplexDouble): ComplexDouble = ComplexDouble(this / other.re, other.im)
public operator fun Double.div(other: ComplexDouble): ComplexDouble = ComplexDouble(this / other.re, other.im)