package org.jetbrains.multik_jvm.math

import org.jetbrains.multik.api.mk
import org.jetbrains.multik.api.ndarray
import org.jetbrains.multik.jvm.JvmMath
import org.jetbrains.multik.ndarray.data.D1
...
class JvmMathTest {
    ...
    fun `test of cumSum function with axis on 3-d ndarray`() {
        ...
        val expectedWith0Axis = mk.ndarray(mk[mk[mk[0, 3], mk[1, 4]], mk[mk[2, 8], mk[7, 12]], mk[mk[9, 17], mk[17, 23]]])
        val expectedWith1Axis = mk.ndarray(mk[mk[mk[0, 3], mk[1, 7]], mk[mk[2, 5], mk[8, 13]], mk[mk[7, 9], mk[17, 20]]])
        val expectedWith2Axis = mk.ndarray(mk[mk[mk[0, 3], mk[1, 5]], mk[mk[2, 7], mk[6, 14]], mk[mk[7, 16], mk[10, 21]]])
