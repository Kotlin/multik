 ...
 */
public fun <T : Number, D : Dimension> MultiArray<T, D>.exp(): NDArray<Double, D> = JvmMath.exp(this)

/**
 * Returns an ndarray of Double from the given ndarray to each element of which a log function has been applied.
 */
public fun <T : Number, D : Dimension> MultiArray<T, D>.log(): NDArray<Double, D> = JvmMath.log(this)

/**
 * Returns an ndarray of Double from the given ndarray to each element of which a sin function has been applied.
 */
public fun <T : Number, D : Dimension> MultiArray<T, D>.sin(): NDArray<Double, D> = JvmMath.sin(this)

/**
 * Returns an ndarray of Double from the given ndarray to each element of which a cos function has been applied.
 */
public fun <T : Number, D : Dimension> MultiArray<T, D>.cos(): NDArray<Double, D> = JvmMath.cos(this)
